...
extern Bool fscanreal(LPJfile *,Real *,const char *,Bool);
extern Bool fscanbool(LPJfile *,Bool *,const char *,Bool);
extern Bool fscanrealarray(LPJfile *,Real *,int,const char *);
extern Bool fscanstring(LPJfile *,String,const char *,Bool);
extern Bool fscanstruct(const LPJfile *,LPJfile *,const char *);
extern Bool fscanarray(LPJfile *,LPJfile *,int *,Bool,const char *);
extern Bool fscanarrayindex(const LPJfile *,LPJfile *,int);
extern Bool iskeydefined(const LPJfile *,const char *);
extern Bool isboolean(const LPJfile *,const char *);
extern Bool fscanline(FILE *,char [],int);
...
extern Bool fscanint(LPJfile *,int *,const char *,Bool);
extern Bool fscansize(LPJfile *,size_t *,const char *,Bool);
extern Bool fscanuint(LPJfile *,unsigned int *,const char *,Bool);
extern Bool fscanfloat(LPJfile *,float *,const char *,Bool);
